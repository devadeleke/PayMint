...
const GoogleButton = ({ label }) => {
  return (
    <button type="button" className="flex w-full items-center justify-center gap-2 rounded-sm border border-slate-200 px-4 py-2.5 text-sm font-medium text-ink transition-colors hover:bg-surface">
